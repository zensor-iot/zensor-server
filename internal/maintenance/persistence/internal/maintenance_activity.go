...
func (m MaintenanceActivity) ToDomain() maintenanceDomain.MaintenanceActivity {
	result := maintenanceDomain.MaintenanceActivity{
...
func FromMaintenanceActivity(value maintenanceDomain.MaintenanceActivity) MaintenanceActivity {
