...
type Execution struct {
	...
	NotificationDaysSent Days        `json:"notification_days_sent"`
...
func (m Execution) ToDomain() maintenanceDomain.Execution {
	result := maintenanceDomain.Execution{
		...
		NotificationDaysSent: maintenanceDomain.Days(m.NotificationDaysSent),
...
func FromExecution(value maintenanceDomain.Execution) Execution {
	result := Execution{
		ID:                   value.ID.String(),
		...
		NotificationDaysSent: Days(value.NotificationDaysSent),
