...
func NewExecutionController(
	service usecases.ExecutionService,
	activityService usecases.ActivityService,
) *ExecutionController {
...
var _ httpserver.Controller = &ExecutionController{}
...
func (c *ExecutionController) AddRoutes(router *http.ServeMux) {
...
func (c *ExecutionController) createExecution() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var body internal.ExecutionCreateRequest
		...
		response := internal.ToExecutionResponse(execution)
...
func (c *ExecutionController) getExecution() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
...
func (c *ExecutionController) markCompleted() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
		var body internal.ExecutionCompleteRequest
		err := httpserver.DecodeJSONBody(r, &body)
		if err != nil {
