...
func NewMaintenanceActivityController(service usecases.MaintenanceActivityService) *MaintenanceActivityController {
	return &MaintenanceActivityController{
		service: service,
	}
}

var _ httpserver.Controller = &MaintenanceActivityController{}

type MaintenanceActivityController struct {
	service usecases.MaintenanceActivityService
}

func (c *MaintenanceActivityController) AddRoutes(router *http.ServeMux) {
...
func (c *MaintenanceActivityController) listActivities() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		activityResponses := make([]internal.MaintenanceActivityResponse, len(activities))
		for i, activity := range activities {
			activityResponses[i] = internal.ToMaintenanceActivityResponse(activity)
		}
...
func (c *MaintenanceActivityController) getActivity() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")

		activity, err := c.service.GetActivity(r.Context(), shareddomain.ID(id))
		if err != nil {
			if errors.Is(err, usecases.ErrMaintenanceActivityNotFound) {
		...
		response := internal.ToMaintenanceActivityResponse(activity)
		httpserver.ReplyJSONResponse(w, http.StatusOK, response)
	}
}

func (c *MaintenanceActivityController) createActivity() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var body internal.MaintenanceActivityCreateRequest
		...
		activity, err := maintenanceDomain.NewMaintenanceActivityBuilder().
...
func (c *MaintenanceActivityController) updateActivity() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
		var body internal.MaintenanceActivityUpdateRequest
		err := httpserver.DecodeJSONBody(r, &body)
		if err != nil {
...
func (c *MaintenanceActivityController) deleteActivity() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
...
func (c *MaintenanceActivityController) activateActivity() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
...
func (c *MaintenanceActivityController) deactivateActivity() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
