...
type TenantService interface {
	...
	ListTenants(ctx context.Context, includeDeleted bool) ([]domain.Tenant, error)
...
type TenantRepository interface {
	...
	FindAll(ctx context.Context, includeDeleted bool) ([]domain.Tenant, error)
}
...
func (s *SimpleTenantService) ListTenants(ctx context.Context, includeDeleted bool) ([]domain.Tenant, error) {
	tenants, err := s.repository.FindAll(ctx, includeDeleted)
	if err != nil {
