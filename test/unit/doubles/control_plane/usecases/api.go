...
//
//	mockgen -source=./api.go -destination=../../../test/unit/doubles/control_plane/usecases/api.go -package=usecases -mock_names=DeviceService=MockDeviceService,EvaluationRuleService=MockEvaluationRuleService,TaskService=MockTaskService,ScheduledTaskService=MockScheduledTaskService
//
